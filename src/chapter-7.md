...
HDR uses the concept of 'relations' in a similar sense to that described by Peter-Paul Verbeek, who in his 2015 interactions article unpacks the complexities of designing _'not only the design of technological objects that allow for specific interactions, but also the design of the human subjects who interact with these objects'_. He highlights three approaches to considering human-technology relations–where technology functions as _extensions_ of the human, as _dialectical_ constructs that can oppose us and give us a relation to ourselves, and where human and technology function in the worl in _hybrid_ fashion. He further breaks down the different aspects of relations including _types_, _points of contact_, _influences_ and _mediation_. Such detailed analysis of relations is more granular than this thesis will go into, but this framing could be useful to practitioners wishing to undertake a structured exploration of the ideas of this thesis.

Having scoped HDR through the definition above, we see that 'better' HDR can be achieved by working to empower individuals [[6.3](#6.3)] through pursuit of the identified six wants for data relations. However, as the next section will explain, HDR is motivated in two distinct ways, to which those wants apply differently. As background understanding, let us examine more closely what role data plays in people's lives.
...
It is important to note that the Human Data Relations research agenda, while it views a change from the data-centric status quo as positive, does not imply that to be an HDR reformer one must be an activist. While adversarial design [[9.5.2](#9.5.2)] and collective activism [[10.1.10](#10.1.10)] are clearly useful approaches to progress HDR, systems can also be changed from within. Designers and thought leaders within data-centric organisations and governments could embrace HDR's objectives themselves. The fact that so many of the HDR reform communities mentioned in the previous section are somewhat activist in nature, is more of a reflection of the reality that the goals of HDR cannot easily surface within the dominant digital commerce paradigms of today, and so people - pursuing both individualist [[3.1](#3.1)] and collective agendas [[10.1.10](#10.1.10)], operate at the grassroots level, and may seem to many to be activists. While this thesis leans more into the activist angle of HDR research, motivated by the researcher's background [[1.1.1](#1.1.1)], balance is sought through the fact that the embedded project work track has included work in projects both inside (BBC R&D, SILVER) and outside (Hestia.ai, DERC) of the system [see [Section IV Introduction](#section-iv-embedded-project-settings)].
