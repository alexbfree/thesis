...
The major contribution of this thesis, beyond the detail and evidence for these wants conveyed in chapters 4 to 6, is to synthesise these findings and conceptualise what people want from data holders into a clearly defined field for future research and innovation. Repurposing a phrase that has been only very lightly used previously in the fields of philosophy, tangible/embodied interaction and the performing arts [@ihde1990;@hogan2012;@windeyer2021], I have chosen to name this field **_"Human Data Relations"_**. This term expands upon Human Data Interaction to define something wider, broader and more sociotechnical, encompassing all aspects of the ways in which people and organisations can and should relate to data. The phrase has three distinct connotations which comprise its definition:
