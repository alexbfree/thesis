...
- Closed, Insular and Introspective Practices - [8.5.2](#8.5.2)
- Complex and Invisible Personal Data Ecosystems - [8.3.1](#8.3.1)
- Diminishing Individual Agency - [8.4.2](#8.4.2)
- Data Holder Hegemony - [8.4.1](#8.4.1)
- Immobile Data - [8.2.1](#8.2.1)
- Inaccessible Data - [8.1.1](#8.1.1),  [8.2.1](#8.2.1)
- Insufficient Machine Understanding of Human Data - [8.5.4](#8.5.5)
- Intractable Data Self, the - [8.4.3](#8.4.3)
- Invisible Data - [8.1.1](#8.1.1)
- Lack of Metadata - [8.3.2](#8.3.2)
- Lack of Individual Demand - [8.5.1](#8.5.1)
- Lack of Interoperability - [8.5.4](#8.5.4)
- Lack of Provider Investment - [8.5.3](#8.5.3)
- Non-Interrogable Data - [8.2.1](#8.2.1)
...
- **Information Standards** - [5.5.1](#5.5.1), [8.5](#8.5)
...
- **Critical Algorithm Studies** - research into making computer systems and their behaviour more understandable and accountable
...
- **Data Self** - the representation of an individual in data through which state or commercial actors understand that person when making decisions
...
- **Information Landscape** - the general terrain of available information that a user can see and interact with through the services and apps they use
...
- **Negotiability** - the ability described in HDI to flexibly adapt and change one's preferences as the world or digital system changes
...
- **Power, Resource Control** - controlling the flow of resources
