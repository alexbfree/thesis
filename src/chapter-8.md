...
At the time of publication of this thesis (August 2022), I continue to be employed by Hestia.ai, working on the research, design and development of tools to help collectives [[Principle 10](#principle-10)] with data, make data easier to understand [[6.1.2](#6.1.2); [7.7](#7.7)], and exploring methods to help people 'hack the seams' of digital platforms and services [[9.4](#9.4)].
