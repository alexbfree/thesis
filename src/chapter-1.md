...
- In social care [[Chapter 4](#chapter-4)], families want to be given a voice, and an ability to see and meaningfully interact with their data. They want to be able to influence how they are understood through data, and to be able to explain and discuss their data with authorities. The Case Study (and its pilot study [[Appendix A](#appendix-a)] validate prior findings that highlight families' difficulties with civic data, while documenting their ideas for improving the use of their civic data and for improving empowerment and trust within the support context.
