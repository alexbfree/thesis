...
[Chapter 6](#chapter-6) synthesises the two case studies, and answers RQ and RQ2, bringing the central academic research of the thesis to a close based on findings and discursive insights from both studies backed by literature references. The answer to RQ1 is provided [[6.1](#6.1)] as people's three wants from direct data relations (for it to be visible, understandable and useable), and the answer to RQ2 is provided [[6.2](#6.2)] as people's three wants from indirect data relations (process transparency, individual oversight, and involvement). The chapter concludes [[6.3](#6.3)] by outlining this thesis's perspective power and positioning the pursuit of these six _'data wants'_ as _empowerment_ relative to that perspective and thus as _'better HDR'_.
