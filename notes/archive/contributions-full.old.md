...
Providers of care want to be more data-centric to improve accuracy [[4.1.2](#4.1.2), [4.3.3](#4.3.3)], while supported families want a more human, less data-centric treatment. [4.3.4](#4.3.4) describes a novel model that has the potential to address both parties' conflicting needs and enhance the support relationship: _Shared Data Interaction_. While this was not evaluated in the field, it is consistent with emergent practices [[4.4.1](#4.4.1)], and–after thorough exploration by participants [[Table 3.1](#table-3.1)]–was perceived to be beneficial. The expected benefits (and challenges) of such an approach are explored in [4.5.3](#4.5.3). The success of this study's methodology [[3.4.2](#3.4.2)] provides further evidence for the effectiveness of bringing people together around representations of data, echoing other researchers' work on _boundary objects_ [@star1989] and _things to think with_ [@brandt2004].
